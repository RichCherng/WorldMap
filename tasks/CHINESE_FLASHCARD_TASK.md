...
- ✅ **Integrate Flash Card UI with gRPC-Web Service**
  ...
  - **Subtasks:**
    ...
    - ✅ **Phase 5: Cleanup and documentation**
      ...
      - ✅ Final testing
  - **Date:** November 17, 2025
  - **Note:** Moved to [CHINESE_FLASHCARD_TASK2.md](CHINESE_FLASHCARD_TASK2.md)
  ...
  - **Subtasks:**
    ...
    - ❌ **Update Data Layer to Use Firestore Service**
      ...
      - **Feature Flag Example:**
        ...
        ```typescript
        const USE_FIRESTORE_DIRECT =
          process.env.REACT_APP_USE_FIRESTORE_DIRECT === "true";
...
- ✅ **Organize Vocabulary List**
  - **Description:** Improve the organization and presentation of the vocabulary list in the UI.
  - **Branch:** `organize-vocab-list`
  - **Subtasks:**
    - ✅ **Refactor VocabList Component**
      - Extract `AnimatedItem` into `frontend/src/Pages/FlashCard/VocabCollections/components/AnimatedItem.tsx`
      - Extract `EditVocabDialog` into `frontend/src/Pages/FlashCard/VocabCollections/components/EditVocabDialog.tsx`
      - Clean up `VocabList.tsx` imports and structure
    - ✅ **Add Sorting Functionality**
      - Add sort dropdown UI to `VocabList`
      - Implement sorting logic (Reverse Chronological (Default), Alphabetical by Pinyin, Alphabetical by English)
      - Update `vocabEntry` interface to include `createdAt` for date sorting
    - ✅ **UI Improvements**
...
**Completed Tasks:** Protocol Buffers Setup, gRPC Server Setup, Firestore Service Layer, Chinese Flash Card gRPC API, gRPC-Web Service Layer, UI Components, Full gRPC Integration, Organize Vocabulary List
